...
This trivial project was developed with [Github Spec-kit](https://github.com/github/spec-kit) and [Codex](https://chatgpt.com/codex/enterprise/).  Spec-kit is definitely overkill for this kind of app.
